            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="company" placeholder="Marketing Agency" defaultValue="Marketing Agency" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="role">Job Title</Label>
                  <Input id="role" placeholder="Marketing Director" defaultValue="Marketing Director" />
                </div>
              </div>
              <div className="space-y-2">
